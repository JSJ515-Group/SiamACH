...
def main():
    ...
    parser.add_argument('--train_module', type=str,  default='siamach', help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', type=str,  default='siamach_tracker', help='Name of the train settings file.')
